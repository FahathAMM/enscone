    ...
    <div>
        ...
        <div class="row">
            <div class="col-lg-4 col-xl-3 p-0">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center mb-4">
                            @if ($avatar)
                                <img class="mr-3" src="{{ $avatar->temporaryUrl() }}" width="80" height="80"
                            ...
                            @else
                                @if ($user->google_id)
                                    <img class="mr-3" src="{{ $user->avatar }}" width="80" height="80"
                                        alt="" style="border-radius: 50px;">
                                @else
                                    <img class="mr-3" src="{{ asset('storage/' . $user->avatar) }}" width="80"
                ...
                <div class="card">
                    <div class="card-body">
                        <button wire:click="databaseBackup" class="btn btn-primary btn-block">Database Backup</button>
                        <div wire:loading wire:target="databaseBackup">
            ...
            <div class="col-lg-8 col-xl-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <textarea wire:model.defer="about_me" class="form-control form-control-sm" type="text" placeholder="About"
