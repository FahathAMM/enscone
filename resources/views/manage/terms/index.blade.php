            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="margin-left: 112px;">
                        <form class="image-upload" method="post" action="{{ route('terms.store') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Author Name</label>
                                <input type="text" name="group" class="form-control" style="width: 1030px" />
                            </div>
                            <div class="form-group">
                                <textarea name="desc" class="textarea" style="width: 1030px; height: 1000px"></textarea>
                            </div>
                            <div class="form-group">
